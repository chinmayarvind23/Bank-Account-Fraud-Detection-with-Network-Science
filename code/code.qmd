...
```{r}
load_dot_env(file = "C:/Users/rylan/Desktop/421 Project/Bank-Account-Fraud-Detection-with-Network-Science/data.env")
...
bankfraud_data <- read_csv("C:/Users/rylan/OneDrive/Base.csv")
bankfraud_data
```
...
plot(graph, vertex.size = 2, edge.width = 1, edge.color = E(graph)$color)
```
